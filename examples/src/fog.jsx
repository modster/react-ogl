...
const Model = ({ modelUrl, textureUrl }) => {
  ...
  useFrame((_, t) => {
    ...
    mesh.current.position.z = Math.sin(t * 0.0004) * 3.0

    mesh.current.program.uniforms.uTime.value = t * 0.001
  })
    ...
    <mesh ref={mesh}>
      <program
        ...
        uniforms={{
          ...
          uFogColor: { value: new OGL.Color('#ffffff') },
          uFogNear: { value: 2 },
          uFogFar: { value: 15 },
        }}
      />
...
const Fog = () => (
  <Canvas onCreated={({ gl }) => gl.clearColor(1, 1, 1, 1)}>
